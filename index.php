  ...
  <body>
    ...
    <div class="col-lg-4 col-md-12 col-sm-12">
      <label for="a" class="form-label">a</label>
        <input type="text" class="form-control" name="a" id="a"></div>

    <div class="col-lg-4 col-md-12 col-sm-12">
      <label for="b" class="form-label">b</label>
        <input type="text" class="form-control" name="b" id="b"></div>

    <div class="col-lg-4 col-md-12 col-sm-12">
      <label for="c" class="form-label">c</label>
        <input type="text" class="form-control" name="c" id="c"></div>
    ...
    <script>
      function calcularDelta(){
        ...
        //armazenamos os valores em variaveis
        const a = document.getElementById("a").value;
        const b = document.getElementById("b").value;
        const c = document.getElementById("c").value;

        
        //criamos um objeto com todas as variaveis
        ...
        .then(dados => {
            //alert("O resultado do cálculo é: " + dados.delta);
